...
if __name__ == "__main__":
    ...
    model_path = r"logs/Epoch5-Total_Loss7.7556-Val_Loss6.0903.pth"
    ...
    #   获得图片路径和标签
    # ----------------------------------------------------#
    annotation_path = 'VOCdevkit/VOC2012/2012_train.txt'
    # ----------------------------------------------------------------------#
    #   验证集的划分在train.py代码里面进行
    #   2012_test.txt和2012_val.txt里面没有内容是正常的。训练不会使用到。
